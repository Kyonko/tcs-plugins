...
function tcs.mf.ui.listsopenb:action()
	ShowDialog(tcs.mf.ui.listschoicemaindlg)
	tcs.mf.ui.dlg.active = "NO"
end
--Listschoices!
...
tcs.mf.ui.listscancelb = iup.stationbutton { title = "Cancel" }
tcs.mf.ui.listschoicemainbox = iup.pdarootframe {
	iup.pdasubframebg {
		iup.vbox {
			iup.label { title = "Which list would you like to edit?" },
			iup.fill { size = "10" },
			iup.hbox { 
				tcs.mf.ui.fandeopenb,
				tcs.mf.ui.guildopenb,
				tcs.mf.ui.listscancelb
			};
			alignment = "ACENTER"
		}
	}
...
tcs.mf.ui.listschoicemaindlg = iup.dialog {
	tcs.mf.ui.listschoicemainbox;
	BORDER="NO", 
	topmost = "YES", 
	RESIZE="NO", 
	MAXBOX="NO", 
...
function tcs.mf.ui.fandeopenb:action()
	...
	HideDialog(tcs.mf.ui.listschoicemaindlg)
end
...
function tcs.mf.ui.listscancelb:action()
	HideDialog(tcs.mf.ui.listschoicemaindlg)
